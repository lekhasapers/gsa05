...
int main () {
  ...
  b0.upperLeft.x = 9.8;  b0.upperLeft.y = 7.6;
  b0.width = 5.4;  b0.height = 3.2;

  // b1, b2, b3, and b4 all differ in only one respect from b0

  b1.upperLeft.x = 50.0;  b1.upperLeft.y = 7.6;
  b1.width = 5.4;  b1.height = 3.2;

  b2.upperLeft.x = 9.8;  b2.upperLeft.y = 100.0;
  b2.width = 5.4;  b2.height = 3.2;

  b3.upperLeft.x = 9.8;  b3.upperLeft.y = 7.6;
  b3.width = 200.0;  b3.height = 3.2;

  b4.upperLeft.x = 9.8;  b4.upperLeft.y = 7.6;
  ...
  b5.upperLeft.x = 1.2;  b5.upperLeft.y = 3.4;
  b5.width = 5.6;  b5.height = 7.8;

  b6.upperLeft.x = 1.2;  b6.upperLeft.y = 3.4;
